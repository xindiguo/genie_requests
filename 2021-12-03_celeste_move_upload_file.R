...
# Date: 2021-12-03
# Request: 
#   source: celeste sent email saying upload available
#   date requested: 2021-12-03
...
# synapse
synid_file_source <- "syn26525019"
synid_folder_dest <- "syn26243332"
synid_file_dest <- "syn26033209"
...
save_to_synapse(path = entity$path, 
                ...
                file_name = file_name, 
                prov_name = "copy file", 
                prov_desc = "copy file from one entity to another", 
                prov_used = synid_file_source, 
                prov_exec = "https://github.com/hhunterzinck/genie_requests/blob/main/2021-12-03_celeste_move_upload_file.R")
