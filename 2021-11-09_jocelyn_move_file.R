...
# Date: 2021-11-09
# request: https://freedcamp.com/view/3082480/tasks/43245835
...
# synapse
synid_file_source <- "syn26450847"
synid_folder_dest <- "syn26023438"
synid_file_dest <- "syn26117747"
...
save_to_synapse(path = entity$path, 
                ...
                prov_exec = "https://github.com/hhunterzinck/genie_requests/blob/main/2021-11-09_jocelyn_move_file.R")
